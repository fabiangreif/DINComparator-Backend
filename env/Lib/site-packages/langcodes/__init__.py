...
class Language:
    ...
    def prefer_macrolanguage(self) -> 'Language':
        ...
        >>> Language.get().prefer_macrolanguage()
    ...
    def to_alpha3(self, variant: str = 'T') -> str:
        ...
        >>> Language.get().to_alpha3()
        'fra'
        >>> Language.get().to_alpha3()
        'fra'
        >>> Language.get().to_alpha3(variant='B')
        'fre'
        >>> Language.get().to_alpha3(variant='T')
        'deu'
        >>> Language.get().to_alpha3()
        'jpn'
        >>> Language.get().to_alpha3()
        ...
        >>> Language.get(normalize=False).to_alpha3()
        'tgl'
        >>> Language.get().to_alpha3()
        'fil'
        >>> Language.get(normalize=False).to_alpha3()
    ...
    def language_name(
        ...
        >>> Language.get().language_name('sl')
        'slovenščina'
        >>> Language.get().language_name('sk')
        'slovenčina'
        >>> Language.get().language_name('sk')
        'slovinčina'
        >>> Language.get().language_name('sl')
    ...
    def display_name(
        ...
        But you can ask for language names in numerous other languages:
            ...
            >>> Language.get().display_name('fr')
            'français'

            >>> Language.get().display_name('es')
            'francés'

            >>> Language.make().display_name('es')
            'lengua desconocida'

            >>> Language.get().display_name('de')
            'Chinesisch (Vereinfacht)'

            >>> Language.get().display_name('zh-Hans')
            '英语（美国）'
        """
    ...
    def speaking_population(self) -> int:
        ...
        >>> Language.get().speaking_population()
        487664083
        >>> Language.get().speaking_population()
        237135429
        >>> Language.get().speaking_population()
    ...
    def writing_population(self) -> int:
        ...
        >>> all = Language.get().writing_population()
        >>> all
        1240326057

        >>> traditional = Language.get().writing_population()
        >>> traditional
        37019589

        >>> simplified = Language.get().writing_population()
        >>> all == traditional + simplified
        True

        >>> Language.get().writing_population()
        6439733
        >>> Language.get().writing_population()
        338933
        ...
        >>> Language.get(normalize=False).writing_population()
        6778666
